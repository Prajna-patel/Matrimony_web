...
def partner_preference(request):
    try:
        ...
        if request.method == 'POST':
            partner_preference_form = PartnerPreferenceForm(request.POST, instance=partner_preference)
            if partner_preference_form.is_valid():
                partner_preference_form.save()
                messages.success(request, "Your partner preferences have been updated!")  
                return redirect('home')
        else:
            partner_preference_form = PartnerPreferenceForm(instance=partner_preference)
        ...
        if request.method == 'POST':
            ...
            if partner_preference_form.is_valid():
                ...
                messages.success(request, "Your partner preferences have been saved!")  
                return redirect('home')
        else:
